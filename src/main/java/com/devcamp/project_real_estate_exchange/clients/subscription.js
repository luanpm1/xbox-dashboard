...
const gBASE_URL = "http://127.0.0.1:8000/subscriptions/";
...
const gDataTable = $("table").DataTable({
    columns: [
        ...
        { data: gColumns[1], title: "user" },
        { data: gColumns[2], title: "endpoint" },
        { data: gColumns[3], title: "publickey" },
        { data: gColumns[4], title: "authenticationtoken" },
        { data: gColumns[5], title: "contentencoding" },
        { data: gColumns[6], title: "action"}
