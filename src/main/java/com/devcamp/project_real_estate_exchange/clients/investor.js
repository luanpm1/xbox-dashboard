...
const gBASE_URL = "http://127.0.0.1:8000/investors/";
...
const gDataTable = $("table").DataTable({
    columns: [
        ...
        { data: gColumns[2], title: "projects" },
        { data: gColumns[3], title: "address" },
        { data: gColumns[4], title: "phone" },
        { data: gColumns[5], title: "phone2" },
        { data: gColumns[6], title: "fax" },
        { data: gColumns[7], title: "email" },
        { data: gColumns[8], title: "website" },
        { data: gColumns[9], title: "description" },
